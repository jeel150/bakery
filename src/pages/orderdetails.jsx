...
const OrderDetails = ({ order, onClose, onBack, onGenerateInvoice }) => {
  ...
  const handleGenerateInvoice = async () => {
    ...
    pdf.save(`Invoice_${orderData.trackingNumber || orderData._id}.pdf`);
  };
  ...
  return (
    <div className="order-container">
      ...
      <div ref={invoiceRef} style={{ backgroundColor: "#fff", color: "#000", padding: "15px" }}>
      ...
      <button className="invoice-btn" onClick={handleGenerateInvoice}>
        Generate Invoice
      </button>
    </div>
  );
